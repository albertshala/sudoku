...
var _FauxControl = require('../FauxControl');
...
var componentTheme = exports.componentTheme = function componentTheme(baseTheme) {
  return (0, _themes.mapComponentThemes)({
    name: 'TextInput',
    theme: (0, _TextInput.componentTheme)(baseTheme)
  }, {
    name: 'Select',
    theme: {
...
var Trigger = (0, _styles.createStyledComponent)('div', styles.trigger, {
  displayName: 'Trigger'
});
var TriggerContent = (0, _styles.createStyledComponent)('span', styles.triggerContent, {
...
var SelectTrigger = function (_Component) {
  ...
  _createClass(SelectTrigger, [{
    ...
    value: function render() {
      ...
      var ArrowIcon = isOpen ? _IconArrowDropdownUp2.default : _IconArrowDropdownDown2.default;
      var Arrow = (0, _styles.createStyledComponent)(ArrowIcon, {
        margin: (0, _styles.pxToEm)(iconMarginMap[size])
      }, {
        withProps: {
          size: size === 'small' || size === 'medium' ? 'medium' : (0, _styles.pxToEm)(24)
        }
      });
      ...
      var rootProps = _extends({
        afterItems: [_jsx(Arrow, {}, 'arrow'), _react2.default.createElement('input', _extends({}, inputProps, { key: 'input' }))],
        control: Trigger,
