...
var _ItemMatcher = require('../Dropdown/ItemMatcher');
...
var componentTheme = exports.componentTheme = function componentTheme(baseTheme) {
  return (0, _themes.mapComponentThemes)({
    name: 'Dropdown',
    theme: (0, _Dropdown.componentTheme)(baseTheme)
  }, {
    name: 'Select',
    theme: {}
  }, _extends({}, (0, _SelectTrigger.componentTheme)(baseTheme), baseTheme));
};

var ThemedDropdown = (0, _themes.createThemedComponent)(_Dropdown2.default, function (_ref) {
...
var Root = (0, _styles.createStyledComponent)(ThemedDropdown, {
  width: '100%',
...
var Select = function (_Component) {
  ...
  function Select() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = Select.__proto__ || Object.getPrototypeOf(Select)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
    ...
    }, _this.id = _this.props.id || 'select-' + (0, _utils.generateId)(), _this.getItems = (0, _memoizeOne2.default)(_Menu.getItems, _reactFastCompare2.default), _this.getStateAndHelpers = function () {
      return {
        state: {
      ...
      return _extends({}, (0, _utils.isRenderProp)(trigger) ? props : {}, (_extends2 = {
      ...
      }, _defineProperty(_extends2, refKey, _this.setTriggerRef), _defineProperty(_extends2, 'variant', variant), _extends2), !(0, _utils.isRenderProp)(trigger) ? props : {}, !readOnly ? { onKeyDown: _this.onTriggerKeyDown } : {});
      ...
      return _react2.default.createElement(_SelectTrigger2.default, _this.getTriggerProps(props));
      ...
      return _react2.default.createElement(_Menu2.default, _this.getMenuProps(props));
      ...
      return _react2.default.createElement(_MenuItem2.default, _this.getItemProps(props));
      ...
      var node = (0, _reactDom.findDOMNode)(_this.selectTrigger); // eslint-disable-line react/no-find-dom-node
    ...
    value: function render() {
      ...
      return _jsx(_ModifiersContext2.default.Consumer, {}, void 0, function (contextModifiers) {
        ...
        return _react2.default.createElement(
          Root,
          rootProps,
          (0, _utils.isRenderProp)(trigger) ? _this2.renderTrigger : _this2.renderTrigger()
        );
      });
    }
  }]);
...
Select.propTypes = {
   ...
   * (see [example](#data))
   */
  data: _propTypes2.default.oneOfType([function () {
    return (typeof _Menu.bpfrpt_proptype_Items === 'function' ? _Menu.bpfrpt_proptype_Items : _propTypes2.default.shape(_Menu.bpfrpt_proptype_Items)).apply(this, arguments);
  }, function () {
    return (typeof _Menu.bpfrpt_proptype_ItemGroups === 'function' ? _Menu.bpfrpt_proptype_ItemGroups : _propTypes2.default.shape(_Menu.bpfrpt_proptype_ItemGroups)).apply(this, arguments);
  }]).isRequired,
   ...
   */
  defaultHighlightedIndex: _propTypes2.default.number,
  ...
  placement: _propTypes2.default.oneOf(['bottom-end', 'bottom-start', 'top-end', 'top-start']),
