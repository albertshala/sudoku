...
function createThemedComponent(WrappedComponent, theme) {
  var Wrapper = function Wrapper(props, context) {
    ...
    return _jsx(_ThemeProvider2.default, {
      theme: outTheme
    }, void 0, _react2.default.createElement(WrappedComponent, outProps));
  };

  Wrapper.propTypes = WrappedComponent.propTypes;

  Wrapper.displayName = (0, _wrapDisplayName2.default)(WrappedComponent, 'Themed');

  return (0, _withTheme2.default)(Wrapper);
}