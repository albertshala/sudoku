...
var componentTheme = exports.componentTheme = function componentTheme(baseTheme) {
  return _extends({
    ...
    TableCell_paddingVertical_spacious: (0, _styles.pxToEm)(12),
...
var createRootNode = function createRootNode(props) {
  ...
  return (0, _styles.createStyledComponent)(element, styles, {
...
var TableCell = function (_PureComponent) {
  ...
  function TableCell() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = TableCell.__proto__ || Object.getPrototypeOf(TableCell)).call.apply(_ref2, [this].concat(args))), _this), _this.getRootNode = (0, _memoizeOne2.default)(createRootNode, function (nextProps, prevProps) {
  ...
  _createClass(TableCell, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          restProps = _objectWithoutProperties(_props, ['children', 'primary']);

      var Root = this.getRootNode(this.props);

      return _jsx(_TableBase.TableContext.Consumer, {}, void 0, function (_ref3) {
        var density = _ref3.density,
            highContrast = _ref3.highContrast;

        var rootProps = _extends({
          density: density,
          highContrast: highContrast
        }, primary ? { scope: 'row' } : undefined, restProps);
