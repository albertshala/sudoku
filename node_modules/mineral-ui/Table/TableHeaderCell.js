...
exports.ThemedTableCell = exports.componentTheme = undefined;
...
var componentTheme = exports.componentTheme = function componentTheme(baseTheme) {
  return (0, _themes.mapComponentThemes)({
    name: 'TableCell',
    theme: (0, _TableCell.componentTheme)(baseTheme)
  }, {
    ...
    theme: {
      ...
      TableHeaderCell_paddingVertical: (0, _styles.pxToEm)(12),
...
var ThemedTableCell = exports.ThemedTableCell = (0, _themes.createThemedComponent)(_TableCell2.default, function (_ref) {
...
var styles = function styles(_ref2) {
  ...
  return {
    ...
    '&:not(:first-child)': (_notFirstChild = {}, _defineProperty(_notFirstChild, borderProperty, 0), _defineProperty(_notFirstChild, '&::before', (_before = {}, _defineProperty(_before, borderProperty, borderVertical), _defineProperty(_before, 'bottom', 0), _defineProperty(_before, 'content', '""'), _defineProperty(_before, positionProperty, 0), _defineProperty(_before, 'position', 'absolute'), _defineProperty(_before, 'top', 0), _defineProperty(_before, 'width', 0), _defineProperty(_before, 'zIndex', -1), _before)), _notFirstChild)
  };
};

var createRootNode = function createRootNode(props) {
  var _props$element = props.element,
      element = _props$element === undefined ? TableHeaderCell.defaultProps.element : _props$element;


  return (0, _styles.createStyledComponent)(ThemedTableCell, styles, {
    displayName: 'TableHeaderCell',
    filterProps: ['width'],
    forwardProps: ['element', 'noPadding', 'textAlign'],
    rootEl: element,
    withProps: { element: element }
  });
};
...
var TableHeaderCell = function (_PureComponent) {
  ...
  function TableHeaderCell() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref3 = TableHeaderCell.__proto__ || Object.getPrototypeOf(TableHeaderCell)).call.apply(_ref3, [this].concat(args))), _this), _this.getRootNode = (0, _memoizeOne2.default)(createRootNode, function (nextProps, prevProps) {
  ...
  _createClass(TableHeaderCell, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          label = _props.label,
          restProps = _objectWithoutProperties(_props, ['children', 'label']);

      var Root = this.getRootNode(this.props);

      return _jsx(_TableBase.TableContext.Consumer, {}, void 0, function (_ref4) {
        var density = _ref4.density,
            highContrast = _ref4.highContrast;
