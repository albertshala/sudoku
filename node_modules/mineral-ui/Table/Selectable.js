...
exports.bpfrpt_proptype_ToggleAll = exports.bpfrpt_proptype_Toggle = exports.bpfrpt_proptype_SelectableType = undefined;
...
var bpfrpt_proptype_SelectableType = {
  ...
  some: _propTypes2.default.bool.isRequired,
  isSelected: _propTypes2.default.func.isRequired,
  toggle: function toggle() {
    return (typeof Toggle === 'function' ? _propTypes2.default.instanceOf(Toggle).isRequired : _propTypes2.default.any.isRequired).apply(this, arguments);
  },
  toggleAll: function toggleAll() {
    return (typeof ToggleAll === 'function' ? _propTypes2.default.instanceOf(ToggleAll).isRequired : _propTypes2.default.any.isRequired).apply(this, arguments);
  }
};
var bpfrpt_proptype_Toggle = _propTypes2.default.func;
var bpfrpt_proptype_ToggleAll = _propTypes2.default.func;
...
var Selectable = function (_Component) {
  ...
  _createClass(Selectable, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (!(0, _reactFastCompare2.default)(this.props.selected, nextProps.selected)) {
        this.setState({
...
Selectable.propTypes = {
  ...
  defaultSelected: function defaultSelected() {
    return (typeof Data === 'function' ? _propTypes2.default.instanceOf(Data) : _propTypes2.default.any).apply(this, arguments);
  },
...
exports.bpfrpt_proptype_SelectableType = bpfrpt_proptype_SelectableType;
exports.bpfrpt_proptype_Toggle = bpfrpt_proptype_Toggle;
exports.bpfrpt_proptype_ToggleAll = bpfrpt_proptype_ToggleAll;