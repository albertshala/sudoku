...
var _PopoverContent = require('../Popover/PopoverContent');
...
var Tooltip = function (_Component) {
  ...
  function Tooltip() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref3 = Tooltip.__proto__ || Object.getPrototypeOf(Tooltip)).call.apply(_ref3, [this].concat(args))), _this), _this.state = {
    ...
    }, _this.id = _this.props.id || 'tooltip-' + (0, _utils.generateId)(), _this.getTriggerProps = function () {
      var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      return _extends({}, props, {
        'aria-expanded': undefined,
        onBlur: (0, _utils.composeEventHandlers)(props.onBlur, _this.close),
        onFocus: (0, _utils.composeEventHandlers)(props.onFocus, _this.handleDelayedOpen),
        onMouseEnter: (0, _utils.composeEventHandlers)(props.onMouseEnter, _this.handleDelayedOpen),
        onMouseLeave: (0, _utils.composeEventHandlers)(props.onMouseLeave, _this.close),
        tabIndex: 0
      });
      ...
      return _react2.default.createElement(_PopoverContent2.default, _this.getContentProps(props));
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(Root, popoverProps);
    }
  }]);
