...
exports.createRootNode = exports.componentTheme = undefined;
...
var _TextProvider = require('./TextProvider');

var _TextProvider2 = _interopRequireDefault(_TextProvider);
...
var styles = {
  ...
  noInherit: function noInherit(_ref2) {
    ...
    var styles = _extends({
      ...
      textAlign: (0, _utils.rtlTextAlign)(align, theme.direction)
...
var createRootNode = exports.createRootNode = function createRootNode(props) {
  ...
  return (0, _styles.createStyledComponent)(element, inherit ? styles.inherit : styles.noInherit, {
    rootEl: element,
...
var Text = function (_Component) {
  ...
  _createClass(Text, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_TextProvider2.default, rootProps);
    }
  }]);
...
Text.contextTypes = {
  parentElement: _propTypes.string
};
Text.propTypes = {
  /** Available horizontal alignments */
  align: _propTypes2.default.oneOf(['start', 'end', 'center', 'justify']),

  /** Available styles */
  appearance: _propTypes2.default.oneOf(['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'mouse', 'p', 'prose']),
  ...
  fontWeight: _propTypes2.default.oneOfType([_propTypes2.default.oneOf(['regular']), _propTypes2.default.oneOf(['semiBold']), _propTypes2.default.oneOf(['bold']), _propTypes2.default.oneOf(['extraBold']), _propTypes2.default.number]),
  ...
  parentElement: _propTypes2.default.string,

  /** Force display to one line and truncate with ellipsis at given max-width */
  truncate: _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.number, _propTypes2.default.string])
};
