...
exports.bpfrpt_proptype_RenderFn = exports.componentTheme = undefined;
...
var _ItemMatcher = require('./ItemMatcher');
...
var Dropdown = function (_Component) {
  ...
  function Dropdown() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Dropdown.__proto__ || Object.getPrototypeOf(Dropdown)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    }, _this.id = _this.props.id || 'dropdown-' + (0, _utils.generateId)(), _this.getItems = (0, _memoizeOne2.default)(_Menu.getItems, _reactFastCompare2.default), _this.getStateAndHelpers = function () {
      return {
        state: {
      ...
      return _react2.default.createElement(_DropdownContent2.default, _this.getContentProps(props));
      ...
      return _extends({}, (0, _utils.isRenderProp)(children) ? props : {}, isOpen ? {
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _Popover2.default,
        rootProps,
        (0, _utils.isRenderProp)(children) ? this.renderTrigger : this.renderTrigger()
      );
    }
  }]);
...
Dropdown.propTypes = {
  ...
  placement: _propTypes2.default.oneOf(['bottom-end', 'bottom-start', 'left-end', 'left-start', 'right-end', 'right-start', 'top-end', 'top-start']),
...
exports.bpfrpt_proptype_RenderFn = bpfrpt_proptype_RenderFn;