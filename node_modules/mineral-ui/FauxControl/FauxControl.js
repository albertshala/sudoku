...
var FauxControl = function (_Component) {
  ...
  function FauxControl() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref7 = FauxControl.__proto__ || Object.getPrototypeOf(FauxControl)).call.apply(_ref7, [this].concat(args))), _this), _this.getControlNode = (0, _memoizeOne2.default)(createControlNode, function (nextProps, prevProps) {
...
FauxControl.propTypes = {
  ...
  control: function control() {
    return (typeof React$ComponentType === 'function' ? _propTypes2.default.instanceOf(React$ComponentType).isRequired : _propTypes2.default.any.isRequired).apply(this, arguments);
  },
  ...
  fauxControlRef: _propTypes2.default.func,
