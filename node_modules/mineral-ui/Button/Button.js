...
var Button = function (_Component) {
  ...
  function Button() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref5 = Button.__proto__ || Object.getPrototypeOf(Button)).call.apply(_ref5, [this].concat(args))), _this), _this.getRootNode = (0, _memoizeOne2.default)(createRootNode, function (nextProps, prevProps) {
