...
var Title = (0, _styles.createStyledComponent)(_Text2.default, styles.titleContent);

var variantIcons = {
  danger: _IconDanger2.default,
  success: _IconSuccess2.default,
  warning: _IconWarning2.default
};
...
var DialogTitle = function DialogTitle(_ref2) {
  ...
  var TitleContent = function TitleContent(props) {
    return _react2.default.createElement(Title, _extends({ id: id }, props));
  };
...
exports.default = (0, _themes.withTheme)(DialogTitle);