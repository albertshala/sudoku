...
var createRootNode = function createRootNode(props) {
  var component = props.flex ? Flex : Box;
...
var FlexItem = function (_Component) {
  ...
  function FlexItem() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = FlexItem.__proto__ || Object.getPrototypeOf(FlexItem)).call.apply(_ref2, [this].concat(args))), _this), _this.getRootNode = memoizeOne(createRootNode, function (nextProps, prevProps) {
...
FlexItem.propTypes = {
  ...
  alignSelf: PropTypes.oneOfType([PropTypes.oneOf(['start']), PropTypes.oneOf(['end']), PropTypes.oneOf(['center']), PropTypes.oneOf(['stretch']), PropTypes.arrayOf(PropTypes.oneOf(['start', 'end', 'center', 'stretch']))]),
   ...
   * [[Responsive-capable]](#responsive)
   */
  grow: PropTypes.oneOfType([PropTypes.number, PropTypes.arrayOf(PropTypes.number)]),

  /**
   * Shrink factor along the main axis ([see example](#shrink))
   * [[Responsive-capable]](#responsive)
   */
  shrink: PropTypes.oneOfType([PropTypes.number, PropTypes.arrayOf(PropTypes.number)])
};
