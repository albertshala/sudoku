...
var Popover = function (_Component) {
  ...
  function Popover() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Popover.__proto__ || Object.getPrototypeOf(Popover)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    }, _this.id = _this.props.id || 'popover-' + generateId(), _this.getStateAndHelpers = function () {
      return {
        state: {
      ...
      return _extends({}, props, {
        ...
        tabIndex: 0,
        title: title,
        onBlur: composeEventHandlers(content && content.props && content.props.onBlur, _this.onBlur)
      });
      ...
      return _extends({}, isRenderProp(children) ? props : {}, {
        ...
        onBlur: composeEventHandlers(props.onBlur, _this.onBlur),
        onClick: !disabled ? composeEventHandlers(props.onClick, _this.toggleOpen) : undefined
      });
      ...
      return React.createElement(PopoverTrigger, _this.getTriggerProps(_extends({}, child.props, { children: child })));
...
Popover.propTypes = {
   ...
   * and [React docs](https://reactjs.org/docs/render-props.html).
   */
  content: PropTypes.oneOfType([function () {
   ...
   * closed.
   */
  focusTriggerOnClose: PropTypes.bool,
...
export { bpfrpt_proptype_RenderFn };