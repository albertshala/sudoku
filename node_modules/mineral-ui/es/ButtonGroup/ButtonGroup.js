...
var isChecked = function isChecked(checked, index) {
  ...
  var checkedSet = isSet ? checked : setFromArray(toArray(checked));
...
var Root = createStyledComponent('div', styles, {
  ...
  _createClass(ButtonGroup, [{
    ...
    value: function render() {
      ...
      var buttons = Children.map(children, function (child, index) {
        ...
        return cloneElement(child, _extends({}, isChildToggleable ? { 'aria-checked': isChildChecked } : undefined, {
          'data-index': index,
...
ButtonGroup.propTypes = {
   ...
   */
  checked: PropTypes.oneOfType([PropTypes.number, PropTypes.arrayOf(PropTypes.number.isRequired)]),
   ...
   */
  defaultChecked: PropTypes.oneOfType([PropTypes.number, PropTypes.arrayOf(PropTypes.number.isRequired)]),
