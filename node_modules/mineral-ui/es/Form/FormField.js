...
var FormField = function (_Component) {
  ...
  function FormField() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref4 = FormField.__proto__ || Object.getPrototypeOf(FormField)).call.apply(_ref4, [this].concat(args))), _this), _this.id = _this.props.id || 'formField-' + generateId(), _this.getControlName = function () {
...
FormField.propTypes = {
   ...
   * text
   */
  caption: PropTypes.oneOfType([PropTypes.string, function () {
  ...
  input: function input() {
    return (typeof React$ComponentType === 'function' ? PropTypes.instanceOf(React$ComponentType) : PropTypes.any).apply(this, arguments);
  },
  ...
  requiredText: PropTypes.oneOfType([PropTypes.string, function () {
    return (typeof React$Element === 'function' ? PropTypes.instanceOf(React$Element) : PropTypes.any).apply(this, arguments);
  }]),
