...
var DialogRow = function (_Component) {
  ...
  function DialogRow() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = DialogRow.__proto__ || Object.getPrototypeOf(DialogRow)).call.apply(_ref2, [this].concat(args))), _this), _this.getRootNode = memoizeOne(createRootNode, function (nextProps, prevProps) {
