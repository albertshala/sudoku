...
var OverflowContainer = function (_Component) {
  ...
  function OverflowContainer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = OverflowContainer.__proto__ || Object.getPrototypeOf(OverflowContainer)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
      ...
      var scrollable = Boolean(scrollX && node && node.scrollWidth > node.clientWidth || scrollY && node && node.scrollHeight > node.clientHeight);
      if (_this.state.scrollable !== scrollable) {
        _this.setState({
          scrollable: scrollable
        });
      }
    }, _this.handleWindowResize = debounce(_this.updateScrollable, 500), _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(OverflowContainer, [{
    ...
    value: function render() {
      ...
      }, this.state.scrollable ? { tabIndex: 0 } : undefined, restProps);
