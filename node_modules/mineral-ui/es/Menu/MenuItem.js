...
var styles = {
  ...
  text: function text(props) {
    ...
    var margin = getNormalizedValue(theme.space_inline_sm, fontSize);
...
var Root = createStyledComponent('div', styles.menuItem, {
...
var MenuItem = function (_Component) {
  ...
  _createClass(MenuItem, [{
    ...
    value: function render() {
      ...
      var endIcon = iconEnd && cloneElement(iconEnd, { size: pxToEm(24), key: 'iconEnd' });
...
import { bpfrpt_proptype_Item } from './Menu';
