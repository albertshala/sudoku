...
var TableHeaderRow = function (_Component) {
  ...
  _createClass(TableHeaderRow, [{
    ...
    value: function render() {
      ...
      return _jsx(TableRow, {}, void 0, selectable ? _jsx(TableSelectableCell, {
      ...
      }) : null, columns.map(function (_ref2) {
        var content = _ref2.content,
            columnSortable = _ref2.sortable,
            key = _ref2.key,
            label = _ref2.label,
            restColumn = _objectWithoutProperties(_ref2, ['content', 'sortable', 'key', 'label']);
        ...
        return cellProps.sortable ? React.createElement(TableSortableHeaderCell, _extends({ name: key }, cellProps)) : React.createElement(TableHeaderCell, cellProps);
      }));
    }
  }]);
...
TableHeaderRow.propTypes = {
  ...
  toggle: function toggle() {
    return (typeof bpfrpt_proptype_ToggleAll === 'function' ? bpfrpt_proptype_ToggleAll : PropTypes.shape(bpfrpt_proptype_ToggleAll)).apply(this, arguments);
  }
};
export default TableHeaderRow;
import { bpfrpt_proptype_ToggleAll } from './Selectable';
