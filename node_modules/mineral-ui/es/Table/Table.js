...
var bpfrpt_proptype_Columns = PropTypes.arrayOf(function () {
  return (typeof Column === 'function' ? PropTypes.instanceOf(Column).isRequired : PropTypes.any.isRequired).apply(this, arguments);
});

// See demos/Table/index.js additionalTypes for descriptions

var bpfrpt_proptype_Messages = {
  deselectAllRows: PropTypes.string.isRequired,
  deselectRow: PropTypes.string.isRequired,
  selectAllRows: PropTypes.string.isRequired,
  selectRow: PropTypes.string.isRequired,
  selectedRows: PropTypes.string.isRequired,
  sortColumnAscending: PropTypes.string.isRequired,
  sortColumnDescending: PropTypes.string.isRequired
};
var bpfrpt_proptype_Row = PropTypes.object;
var bpfrpt_proptype_Rows = PropTypes.arrayOf(PropTypes.object.isRequired);


var generateColumns = function generateColumns(data) {
  return data[0] ? Object.keys(data[0]).reduce(function (acc, cell) {
...
var Table = function (_Component) {
  ...
  _createClass(Table, [{
    ...
    value: function componentWillUpdate(nextProps) {
      var columnsChanged = !deepEqual(this.props.columns, nextProps.columns);
      var dataChanged = !deepEqual(this.props.data, nextProps.data);
    ...
    value: function render() {
      ...
      if (selectable && this.sortable) {
        return React.createElement(SelectableSortableTable, rootProps);
      } else if (selectable) {
        return React.createElement(SelectableTable, rootProps);
      } else if (this.sortable) {
        return React.createElement(SortableTable, rootProps);
      } else {
        var ignoreSortable = rootProps.sortable,
            rootPropsWithoutSortable = _objectWithoutProperties(rootProps, ['sortable']);

        return React.createElement(TableBase, rootPropsWithoutSortable);
      }
    }
  }]);
...
Table.propTypes = {
  ...
  columns: function columns() {
    return (typeof Columns === 'function' ? PropTypes.instanceOf(Columns) : PropTypes.any).apply(this, arguments);
  },
  ...
  defaultSelectedRows: PropTypes.arrayOf(PropTypes.object.isRequired),
  ...
  density: PropTypes.oneOf(['compact', 'spacious']),
  ...
  messages: function messages() {
    return (typeof Messages === 'function' ? PropTypes.instanceOf(Messages) : PropTypes.any).apply(this, arguments);
  },
...
var SelectableTable = function SelectableTable(props) {
  ...
  return React.createElement(
    ...
    function (props) {
      return React.createElement(TableBase, _extends({}, props, { data: data }));
    }
  );
};
...
var SortableTable = function SortableTable(props) {
  return React.createElement(
    ...
    function (_ref5) {
      ...
      return React.createElement(TableBase, _extends({}, props, { data: props.sortable.data }));
    }
  );
};
...
var SelectableSortableTable = function SelectableSortableTable(props) {
  ...
  return React.createElement(
    ...
    _extends({}, props, { data: selectableRows }),
    function (props) {
      return React.createElement(SortableTable, _extends({}, props, { data: data }));
    }
  );
};
/* eslint-enable */
...
import { bpfrpt_proptype_Comparators } from './Sortable';
import PropTypes from 'prop-types';
export { bpfrpt_proptype_Columns };
export { bpfrpt_proptype_Messages };
export { bpfrpt_proptype_Row };
export { bpfrpt_proptype_Rows };